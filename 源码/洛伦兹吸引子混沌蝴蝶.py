...
class Chaos(ThreeDScene):
    def construct(self):
        ...
        for i in range(5000):
            self.update_bodies(self.bodies, 0.1)
            self.update_trajectorys(self.trajs, 0.1)
        ...
        self.wait(0.5)
        self.move_camera(phi=65 * DEGREES, theta=110 * DEGREES, run_time=3,rate_func=smooth)
        self.wait(0.5)
        self.move_camera(phi=110 * DEGREES, theta=550 * DEGREES, run_time=6.5,rate_func=smooth)
        self.wait(0.5)

        self.move_camera(phi=65 * DEGREES, theta=470 * DEGREES, run_time=3,rate_func=smooth)
        self.wait(0.5)
        self.move_camera(phi=100 * DEGREES, theta=550 * DEGREES, run_time=3,rate_func=smooth)
        self.wait(0.5)
        self.move_camera(phi=65 * DEGREES, theta=110 * DEGREES, run_time=6.5,rate_func=smooth)
        self.wait(3)
