...
class PI_visualize(Scene):
    def construct(self):
        ...
        AS0 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[0] * DEGREES, color=DARK_BROWN)
        AS1 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[1] * DEGREES, color=ORANGE)
        AS2 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[2] * DEGREES, color=PURPLE_B)
        AS3 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[3] * DEGREES, color=LIGHT_PINK)
        AS4 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[4] * DEGREES, color=TEAL_B)
        AS5 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[5] * DEGREES, color=BLUE_D)
        AS6 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[6] * DEGREES, color=BLUE_E)
        AS7 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[7] * DEGREES, color=BLUE_B)
        AS8 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[8] * DEGREES, color=GREEN_E)
        AS9 = AnnularSector(inner_radius=3.3,outer_radius =3.5, angle=angle_length * DEGREES,start_angle=start_angles[9] * DEGREES, color=GREEN_B)
        ...
        with open('pi.txt') as file_read:
            while True:
                ...
                #画贝塞尔曲线
                bezier = CubicBezier(start_pos, start_pos_b, end_pos_b,end_pos, stroke_color = colors[old_num],stroke_width=0.4,stroke_opacity=alpha_dy)
